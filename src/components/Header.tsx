...
const Header = () => {
  return (
    <main className='relative text-white font-quicksand w-full bg-footer-texture bg-cover bg-center min-h-[2200px] px-2 '>
      ...
      <h4 className='text-xl font-[700] text-center max-w-[400px]  mx-auto mt-20 sm:text-2xl sm:max-w-[600px]  lg:block lg:text-3xl lg:absolute lg:text-right lg:font-[300] lg:top-[1350px]  lg:right-[4.5%]  lg:max-w-[250px] xl:right-[10.5%]  xl:max-w-[300px] 2xl:right-[16%]'>
