...
const Header = () => {
  return (
    <main className='relative text-white font-quicksand w-full bg-footer-texture bg-cover bg-center min-h-[2200px] px-2 '>
      ...
      <h2 className='text-center text-xl mt-[-20%] mx-auto max-w-[400px] font-[500] sm:mt-[-25%]  sm:text-3xl   sm:max-w-[500px] md:mt-[-28%] md:top-[400px] lg:mt-0 lg:absolute lg:block lg:text-right lg:max-w-[400px] lg:right-[5%] xl:right-[12.5%] 2xl:right-[17%] '>
        Our store is proud to present some of the most innovative guitars on the market
      </h2>
      <h3 className='text-xl font-[300] text-center max-w-[400px]  mx-auto mt-16 sm:text-2xl sm:max-w-[600px] lg:mt-0 lg:block lg:text-3xl lg:max-w-[400px] lg:absolute lg:top-[800px] lg:left-[5%] xl:left-[12.5%] 2xl:left-[17%]   '>
