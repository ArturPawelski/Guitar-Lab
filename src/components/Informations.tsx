  ...
  return (
    <div className='text-white font-quicksand px-3 pb-16 bg-[#0C0C0C] mt-[-2rem] md:mt-0  md:pb-20 ' id='informations'>
      ...
      <section className='max-w-[80%] mx-auto mt-16 gap-12 grid grid-cols-2 place-items-center md:grid-cols-4   '>
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: false }} transition={{ delay: 0.5, duration: 0.5 }} className='grid place-items-center gap-4'>
        ...
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: false }} transition={{ delay: 0.8, duration: 0.5 }} className='grid place-items-center gap-4'>
        ...
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: false }} transition={{ delay: 1.1, duration: 0.5 }} className='grid place-items-center gap-4'>
        ...
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: false }} transition={{ delay: 1.4, duration: 0.5 }} className='grid place-items-center gap-4'>
          <div className='bg-[#0C0C0C] shadow-[inset_0px_3px_4px_rgba(0,0,0,0.1)] shadow-[#8e8e8e] p-3 w-[120px] h-[120px] rounded-full '>
