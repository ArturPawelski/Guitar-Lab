      ...
      {GreenGuitar && (
        <main className='  bg-gradient-to-b   from-[#073926] from-5% to-[#0C0C0C]] to-80% text-white font-quicksand w-full px-2 border-t-[1px] min-h-[750px]'>
          ...
          <section className='relative'>
            ...
            <button className=' absolute right-20 top-0 bg-[#1f5139]  border-[1px] border-[#41b24a] px-8 py-2 rounded-3xl '>more information</button>
          </section>
        </main>
      )}
      ...
      {VioletGuitar && (
        <main className='  bg-gradient-to-b   from-[#490b4b] from-5% to-[#0C0C0C]] to-80% text-white font-quicksand w-full px-2 border-t-[1px] min-h-[750px]'>
          ...
          <section className='relative'>
            ...
            <button className=' absolute right-20 top-0 bg-[#4e1f3c]  border-[1px] border-[#953a9b] px-8 py-2 rounded-3xl '>more information</button>
          </section>
        </main>
      )}
    </div>
